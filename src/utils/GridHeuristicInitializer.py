...
class GridHeuristicInitializer:
    ...
    def __init__(self, node_type, gate_data_axes_ids, pos_data, neg_data, 
            num_gridcells_per_axis=20, consider_all_gates=False, greedy_filtering=False, verbose=False, is_gate_acceptable_func=None):
        self.is_gate_acceptable_func = is_gate_acceptable_func 
    ...
    def construct_heuristic_gates(self):
        ...
        print('in heuristic initializer', self.heuristic_gates)
    ...
    def find_best_gate(self, gate_idx):
        if self.is_gate_acceptable_func:
